                                    ...
                                    <tbody>
                                        <c:forEach var="test" items="${tests}" varStatus="loop">
                                            <tr>
                                                <td>${loop.index + 1}</td>
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/lecturer/tests/${test.id}" class="text-decoration-none">
                                                        ${test.title}
                                                    </a>
                                                </td>
                                                <td>${test.courseName}</td>
                                                <td>
                                                    <fmt:formatDate value="${test.startTime}" pattern="dd/MM/yyyy HH:mm" />
                                                </td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        <button class="btn btn-sm btn-outline-secondary dropdown-toggle" type="button" id="dropdownMenuButton${test.id}" data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="fas fa-ellipsis-v"></i>
                                                        </button>
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton${test.id}">
                                                            <li>
                                                                <a class="dropdown-item" href="${pageContext.request.contextPath}/lecturer/tests/${test.id}">
                                                                    <i class="fas fa-eye me-2"></i>Xem chi tiết
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item" href="${pageContext.request.contextPath}/lecturer/tests/${test.id}/edit">
                                                                    <i class="fas fa-edit me-2"></i>Chỉnh sửa
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item" href="${pageContext.request.contextPath}/lecturer/tests/${test.id}/results">
                                                                    <i class="fas fa-chart-bar me-2"></i>Xem kết quả
                                                                </a>
                                                            </li>
                                                            <li><hr class="dropdown-divider"></li>
                                                            <li>
                                                                <a class="dropdown-item text-danger" href="#" onclick="confirmDeleteTest(${test.id}, '${test.title}')">

                                ...
                                <table class="table table-hover align-middle">
                                    ...
                                    <tbody>
                                        <c:forEach var="course" items="${recentCourses}">
                                            <tr>
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/lecturer/courses/${course.id}" class="text-decoration-none text-dark fw-bold">
                                                        ${course.name}
                                                    </a>
                                                </td>
                                                <td>${course.code}</td>
                                                <td>${course.semesterName}</td>
                                                <td><span class="badge bg-secondary">${course.studentCount}</span></td>
                                                <td>
                                                    <c:choose>
                        ...
                        <c:otherwise>
                            <div class="list-group list-group-flush">
                                <c:forEach var="announcement" items="${recentAnnouncements}">
                                    <a href="${pageContext.request.contextPath}/lecturer/announcements/${announcement.id}" class="list-group-item list-group-item-action px-0 border-bottom-dashed">
                                        ...
                                        <small>
                                            <c:choose>
                                                <c:when test="${not empty announcement.courseName}">
                                                    <span class="badge bg-primary-soft text-primary"><i class="fas fa-book-open me-1"></i>${announcement.courseName}</span>
                                                </c:when>
                                                <c:otherwise>

...
<head>
    ...
    <title>Chỉnh sửa Khóa học - LMSS Lecturer</title>
    ...
    <div class="content-wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4 rounded">
            <div class="container-fluid">
                ...
                <span class="navbar-brand">Chỉnh sửa Khóa học</span>
        ...
        <div class="main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <a href="<%= request.getContextPath() %>/lecturer/courses/view/<%= course.getCourseId() %>" class="btn btn-outline-primary me-2">
                ...
                <div class="form-container">
                    <form action="<%= request.getContextPath() %>/lecturer/courses" method="post" id="editCourseForm" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="4" 
                                      placeholder="Nhập mô tả chi tiết về khóa học..."><%= course.getDescription() != null ? course.getDescription() : "" %></textarea>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="room" name="room" 
                                           value="<%= course.getRoom() != null ? course.getRoom() : "" %>"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="maxStudents" name="maxStudents" 
                                           value="<%= course.getMaxStudents() %>" min="1" max="200" placeholder="VD: 50">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="totalSessions" name="totalSessions" 
                                           value="<%= course.getTotalSessions() %>" min="1" max="100" placeholder="VD: 15">
                                </div>
                            </div>
                        </div>

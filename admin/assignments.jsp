...
<body class="h-screen bg-gray-50 font-sans flex">
    <!-- Sidebar -->
        ...
        <main class="flex-1 p-8 overflow-auto">
            ...
            <div class="flex gap-4 mb-4 text-sm">
                ...
                <select class="border px-2 py-2 rounded">
                    ...
                    <option>Mathematics for Engineers</option>
                </select>
                <select class="border px-2 py-2 rounded">
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y">
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                <div class="font-medium text-blue-600">Calculus Problem Set 3</div>
                                <div class="text-xs text-gray-500">Mathematics for Engineers</div>
                            </td>
                            <td class="px-4 py-3">Mar 10, 2024, 05:00 PM</td>
                            <td class="px-4 py-3">
                                <span class="bg-green-100 text-green-700 px-2 py-1 rounded-full text-xs">Graded</span>
                            </td>
                            <td class="px-4 py-3">
                                <div class="w-full bg-gray-100 rounded-full h-2">
                                    <div class="bg-blue-600 h-2 rounded-full" style="width: 93%"></div>
                                </div>
                                <span class="text-xs text-gray-500">42/45</span>
                            </td>
                            <td class="px-4 py-3">75 pts</td>
                            <td class="px-4 py-3 text-center">
                                <i class="ri-more-2-line text-lg cursor-pointer"></i>
                            </td>
                        </tr>
                        <tr>
                            <td class="px-4 py-3"><input type="checkbox" /></td>
                            <td class="px-4 py-3">
                                <div class="font-medium text-blue-600">Midterm Examination</div>
                                <div class="text-xs text-gray-500">Computer Science 101</div>
                            </td>
                            <td class="px-4 py-3">Mar 15, 2024, 02:00 PM</td>
                            <td class="px-4 py-3">
                                <span class="bg-gray-200 text-gray-700 px-2 py-1 rounded-full text-xs">Pending</span>
                            </td>
                            <td class="px-4 py-3">
                                <div class="w-full bg-gray-100 rounded-full h-2">
                                    <div class="bg-blue-600 h-2 rounded-full" style="width: 75%"></div>
                                </div>
                                <span class="text-xs text-gray-500">45/60</span>
                            </td>
                            <td class="px-4 py-3">100 pts</td>
                            <td class="px-4 py-3 text-center">
                                <i class="ri-more-2-line text-lg cursor-pointer"></i>
                            </td>
                        </tr>

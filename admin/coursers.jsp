        ...
        <nav class="flex-1 overflow-y-auto custom-scrollbar">
            <div class="px-4 py-2">
                ...
                <div class="mt-2 space-y-1">
                    ...
                    <a href="coursers.jsp" class="sidebar-link active flex items-center px-3 py-2 text-sm font-medium text-gray-600 rounded-md hover:bg-gray-50">
                        <div class="w-5 h-5 mr-3 flex items-center justify-center">
...
<header class="bg-white px-8 py-6 shadow-sm flex items-center justify-between">
  <div>
    ...
    <nav class="text-sm text-gray-500">Dashboard > Courses</nav>
  </div>
  <button class="bg-primary text-white px-4 py-2 rounded">+ Add New Course</button>
</header>
...
<div class="p-8 space-y-6">
  ...
  <div class="flex flex-wrap gap-4 items-center">
    ...
    <input type="text" placeholder="Search courses..." class="border px-3 py-2 rounded text-sm flex-1 min-w-[200px]" />
  </div>

  <!-- Courses Grid -->
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    <div class="bg-white rounded shadow hover:shadow-lg transition overflow-hidden">
      <img src="https://www.edynamiclearning.com/wp-content/uploads/2019/09/EDL221-Intro_to_Programming_1a.jpg" class="w-full h-40 object-cover" />
      <div class="p-4">
        <h3 class="text-lg font-semibold mb-1">Introduction to Programming</h3>
        <div class="flex items-center gap-2 text-sm text-gray-500">
          <img src="https://i.pravatar.cc/40" class="w-6 h-6 rounded-full" />
    ...
    <div class="bg-white rounded shadow hover:shadow-lg transition overflow-hidden">
      <img src="https://th.bing.com/th/id/OIP.4sGXQ1gMEatfAI-RUVz_NgHaEc?rs=1&pid=ImgDetMain" class="w-full h-40 object-cover" />
      <div class="p-4">
        <h3 class="text-lg font-semibold mb-1">English Communication</h3>
        <div class="flex items-center gap-2 text-sm text-gray-500">
          <img src="https://i.pravatar.cc/41" class="w-6 h-6 rounded-full" />
    ...
    <div class="bg-white rounded shadow hover:shadow-lg transition overflow-hidden">
      <img src="https://th.bing.com/th/id/OIP.TMbL8fpSKfKQ46GoqRnaMgHaJI?rs=1&pid=ImgDetMain" class="w-full h-40 object-cover" />
      <div class="p-4">
        <h3 class="text-lg font-semibold mb-1">Mathematics Fundamentals</h3>
        <div class="flex items-center gap-2 text-sm text-gray-500">
          <img src="https://i.pravatar.cc/42" class="w-6 h-6 rounded-full" />

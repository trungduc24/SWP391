...
<title>Khóa học của tôi - Hệ thống Quản lý Học tập</title>
...
<li class="px-4 py-2">
<a href="./courses.jsp" class="flex items-center text-primary font-medium">
<div class="w-6 h-6 flex items-center justify-center mr-3">
...
<li class="px-4 py-2">
<a href="./assignments.jsp" data-readdy="true" class="flex items-center text-gray-600 hover:text-primary">
<div class="w-6 h-6 flex items-center justify-center mr-3">
...
<li class="px-4 py-2">
<a href="./forum.jsp" data-readdy="true" class="flex items-center text-gray-600 hover:text-primary">
<div class="w-6 h-6 flex items-center justify-center mr-3">
...
<div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4 mb-6 md:flex md:items-center md:justify-between">
...
<td class="px-6 py-4 whitespace-nowrap">
<div class="text-sm text-gray-900">TS. Trần Minh Tuấn</div>
<div class="text-sm text-gray-500">Khoa CNTT</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="text-sm text-gray-900">Thứ 2, 7:30 - 10:30</div>
<div class="text-sm text-gray-500">Phòng A305</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
...
<a href="./course-detail.jsp?id=CS201" class="px-3 py-1.5 bg-primary text-white text-xs rounded-button hover:bg-primary-dark">Vào học</a>
<a href="./course-documents.jsp?id=CS201" class="px-3 py-1.5 bg-gray-100 text-gray-700 text-xs rounded-button hover:bg-gray-200">Tài liệu</a>
<a href="./course-assignments.jsp?id=CS201" class="px-3 py-1.5 bg-gray-100 text-gray-700 text-xs rounded-button hover:bg-gray-200">Bài tập</a>
</div>
</td>
</tr>
<tr data-progress="60">
...
<td class="px-6 py-4 whitespace-nowrap">
<div class="text-sm text-gray-900">PGS.TS. Lê Thị Hương</div>
<div class="text-sm text-gray-500">Khoa HTTT</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="text-sm text-gray-900">Thứ 4, 13:00 - 16:00</div>
<div class="text-sm text-gray-500">Phòng B204</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center justify-between mb-1">
...
<td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
<div class="flex gap-2 justify-end">
<a href="./course-detail.jsp?id=IT305" class="px-3 py-1.5 bg-primary text-white text-xs rounded-button hover:bg-primary-dark">Vào học</a>
<a href="./course-documents.jsp?id=IT305" class="px-3 py-1.5 bg-gray-100 text-gray-700 text-xs rounded-button hover:bg-gray-200">Tài liệu</a>
<a href="./course-assignments.jsp?id=IT305" class="px-3 py-1.5 bg-gray-100 text-gray-700 text-xs rounded-button hover:bg-gray-200">Bài tập</a>
</div>
</td>
</tr>
<tr data-progress="80">
...
<td class="px-6 py-4 whitespace-nowrap">
<div class="text-sm text-gray-900">ThS. Phạm Văn Đức</div>
<div class="text-sm text-gray-500">Khoa Mạng & TT</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="text-sm text-gray-900">Thứ 6, 9:30 - 12:30</div>
<div class="text-sm text-gray-500">Phòng C103</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center justify-between mb-1">
<span class="text-xs text-gray-500">80%</span>
<span class="text-xs font-medium text-gray-700">16/20 buổi</span>
</div>
<progress class="course-progress w-full h-2" value="80" max="100"></progress>
</td>
<td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
<div class="flex gap-2 justify-end">
<a href="./course-detail.jsp?id=NET202" class="px-3 py-1.5 bg-primary text-white text-xs rounded-button hover:bg-primary-dark">Vào học</a>
<a href="./course-documents.jsp?id=NET202" class="px-3 py-1.5 bg-gray-100 text-gray-700 text-xs rounded-button hover:bg-gray-200">Tài liệu</a>
<a href="./course-assignments.jsp?id=NET202" class="px-3 py-1.5 bg-gray-100 text-gray-700 text-xs rounded-button hover:bg-gray-200">Bài tập</a>
</div>
</td>
</tr>
<tr data-progress="90">
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center">
<div class="w-10 h-10 flex items-center justify-center rounded-lg bg-yellow-100 text-yellow-600 mr-3 flex-shrink-0">
...
<td class="px-6 py-4 whitespace-nowrap">
<div class="text-sm text-gray-900">TS. Nguyễn Văn A</div>
<div class="text-sm text-gray-500">Khoa Thiết kế</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="text-sm text-gray-900">Thứ 3, 8:00 - 11:00</div>
<div class="text-sm text-gray-500">Phòng D101</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center justify-between mb-1">
...
<td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
<div class="flex gap-2 justify-end">
<a href="./course-detail.jsp?id=WEB301" class="px-3 py-1.5 bg-primary text-white text-xs rounded-button hover:bg-primary-dark">Vào học</a>
<a href="./course-documents.jsp?id=WEB301" class="px-3 py-1.5 bg-gray-100 text-gray-700 text-xs rounded-button hover:bg-gray-200">Tài liệu</a>
<a href="./course-assignments.jsp?id=WEB301" class="px-3 py-1.5 bg-gray-100 text-gray-700 text-xs rounded-button hover:bg-gray-200">Bài tập</a>
</div>
</td>
</tr>
<tr data-progress="50">
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center">
<div class="w-10 h-10 flex items-center justify-center rounded-lg bg-red-100 text-red-600 mr-3 flex-shrink-0">
...
<td class="px-6 py-4 whitespace-nowrap">
<div class="text-sm text-gray-900">GS. Hoàng Thị B</div>
<div class="text-sm text-gray-500">Khoa AI</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="text-sm text-gray-900">Thứ 5, 14:00 - 17:00</div>
<div class="text-sm text-gray-500">Phòng E205</div>
</td>
<td class="px-6 py-4 whitespace-nowrap">
<div class="flex items-center justify-between mb-1">
<span class="text-xs text-gray-500">50%</span>
<span class="text-xs font-medium text-gray-700">10/20 buổi</span>
</div>
<progress class="course-progress w-full h-2" value="50" max="100"></progress>
</td>
<td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
<div class="flex gap-2 justify-end">
<a href="./course-detail.jsp?id=AI401" class="px-3 py-1.5 bg-primary text-white text-xs rounded-button hover:bg-primary-dark">Vào học</a>
<a href="./course-documents.jsp?id=AI401" class="px-3 py-1.5 bg-gray-100 text-gray-700 text-xs rounded-button hover:bg-gray-200">Tài liệu</a>
<a href="./course-assignments.jsp?id=AI401" class="px-3 py-1.5 bg-gray-100 text-gray-700 text-xs rounded-button hover:bg-gray-200">Bài tập</a>
</div>
</td>
</tr>
</tbody>
...
<div class="course-row bg-white" data-progress="75">
<div class="flex items-center mb-2">
<div class="w-10 h-10 flex items-center justify-center rounded-lg bg-blue-100 text-blue-600 mr-3 flex-shrink-0">
<i class="ri-code-s-slash-line text-lg"></i>
</div>
<div>
<div class="course-name-mobile">Lập trình hướng đối tượng</div>
<div class="course-info-mobile">CS201</div>
</div>
</div>
<div class="course-info-mobile mb-1">Giảng viên: TS. Trần Minh Tuấn</div>
<div class="course-info-mobile mb-3">Lịch học: Thứ 2, 7:30 - 10:30 • Phòng A305</div>
<div class="mb-2">
<div class="flex items-center justify-between mb-1">
...
<div class="course-row bg-white" data-progress="60">
<div class="flex items-center mb-2">
<div class="w-10 h-10 flex items-center justify-center rounded-lg bg-purple-100 text-purple-600 mr-3 flex-shrink-0">
<i class="ri-database-2-line text-lg"></i>
</div>
<div>
<div class="course-name-mobile">Cơ sở dữ liệu</div>
<div class="course-info-mobile">IT305</div>
</div>
</div>
<div class="course-info-mobile mb-1">Giảng viên: PGS.TS. Lê Thị Hương</div>
<div class="course-info-mobile mb-3">Lịch học: Thứ 4, 13:00 - 16:00 • Phòng B204</div>
<div class="mb-2">
<div class="flex items-center justify-between mb-1">
...
<div class="course-row bg-white" data-progress="80">
<div class="flex items-center mb-2">
<div class="w-10 h-10 flex items-center justify-center rounded-lg bg-green-100 text-green-600 mr-3 flex-shrink-0">
<i class="ri-global-line text-lg"></i>
</div>
<div>
<div class="course-name-mobile">Mạng máy tính</div>
<div class="course-info-mobile">NET202</div>
</div>
</div>
<div class="course-info-mobile mb-1">Giảng viên: ThS. Phạm Văn Đức</div>
<div class="course-info-mobile mb-3">Lịch học: Thứ 6, 9:30 - 12:30 • Phòng C103</div>
<div class="mb-2">
<div class="flex items-center justify-between mb-1">
<span class="text-xs text-gray-500">Tiến độ: 80%</span>
<span class="text-xs font-medium text-gray-700">16/20 buổi</span>
</div>
<progress class="course-progress w-full h-2" value="80" max="100"></progress>
</div>
...
<div class="course-row bg-white" data-progress="90">
<div class="flex items-center mb-2">
<div class="w-10 h-10 flex items-center justify-center rounded-lg bg-yellow-100 text-yellow-600 mr-3 flex-shrink-0">
<i class="ri-pencil-ruler-2-line text-lg"></i>
</div>
<div>
<div class="course-name-mobile">Thiết kế Web</div>
<div class="course-info-mobile">WEB301</div>
</div>
</div>
<div class="course-info-mobile mb-1">Giảng viên: TS. Nguyễn Văn A</div>
<div class="course-info-mobile mb-3">Lịch học: Thứ 3, 8:00 - 11:00 • Phòng D101</div>
<div class="mb-2">
<div class="flex items-center justify-between mb-1">
<span class="text-xs text-gray-500">90%</span>
<span class="text-xs font-medium text-gray-700">18/20 buổi</span>
...
<div class="course-row bg-white" data-progress="50">
<div class="flex items-center mb-2">
<div class="w-10 h-10 flex items-center justify-center rounded-lg bg-red-100 text-red-600 mr-3 flex-shrink-0">
<i class="ri-brain-line text-lg"></i>
</div>
<div>
<div class="course-name-mobile">Trí tuệ nhân tạo</div>
<div class="course-info-mobile">AI401</div>
</div>
</div>
<div class="course-info-mobile mb-1">Giảng viên: GS. Hoàng Thị B</div>
<div class="course-info-mobile mb-3">Lịch học: Thứ 5, 14:00 - 17:00 • Phòng E205</div>
<div class="mb-2">
<div class="flex items-center justify-between mb-1">
<span class="text-xs text-gray-500">50%</span>
<span class="text-xs font-medium text-gray-700">10/20 buổi</span>
...
<a href="./courses.jsp" class="flex flex-col items-center py-2 text-primary">
<div class="w-6 h-6 flex items-center justify-center">
<i class="ri-book-open-line"></i>
</div>

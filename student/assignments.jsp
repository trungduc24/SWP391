...
<title>Bài tập/Kiểm tra - Hệ thống Quản lý Học tập</title>
...
<li class="px-4 py-2">
<a href="https://" data-readdy="true" class="flex items-center text-gray-600 hover:text-primary">
<div class="w-6 h-6 flex items-center justify-center mr-3">
...
<img src="https://" alt="Avatar" class="w-10 h-10 rounded-full object-cover">
<div class="ml-3">
...
<input type="text" class="bg-gray-50 border-none text-gray-900 text-sm rounded-lg block w-full pl-10 p-2.5 focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="Tìm kiếm bài tập, kiểm tra...">
</div>
</div>
...
<img src="https://" alt="Avatar" class="w-8 h-8 rounded-full object-cover">
</button>
</div>
</div>
</div>
...
<button class="bg-white border border-gray-200 text-gray-700 px-4 py-2 rounded-button flex items-center gap-2 whitespace-nowrap hover:bg-gray-50">
<div class="w-5 h-5 flex items-center justify-center">
<i class="ri-calendar-line"></i>
</div>
<span>Lịch nộp bài</span>
</button>
